...
When a user enters their username into the field on the forgot password page and clicks the reset via email button a confirmation message should be displayed informing them of next steps and they should receive an email.
